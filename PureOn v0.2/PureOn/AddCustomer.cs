...
namespace PureOn
{
    public partial class AddCustomer : Form
    {
        ...
        private bool AddCustomervalid()
        {
            ...
            {
                MessageBox.Show("please enter the alte in righrnate phone number in correct format");
                return false;
            }
            else if (doorNo.Text == "")
            {
            ...
            {
                MessageBox.Show("please enter the date of installation");
                return false;
            }
